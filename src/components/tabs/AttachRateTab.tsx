...
export default function AttachRateTab() {
  ...
  const dynamicColumns = useMemo(() => {
    const cols = [
      ...
      { key: 'baseUnits', label: 'Base Units', align: 'right' as const, format: (v: number) => <span className="text-gray-500 font-medium">{v} <span className="text-[10px] ml-0.5">U</span></span> },
    ];
